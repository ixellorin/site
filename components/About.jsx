            ...
            <Grid container alignContent="center" alignItems="center" justify="space-between" className={styles.writeupGrid}>
                ...
                <Grid item justify="flex-start" xs={12} lg={7}>
                    <div className="align-left">
                        ...
                        <p>
                            I spent six years there, gaining 24 months of industry experience through the Computer Science Co-Op program. I worked in Vancouver for <b>VISIER</b>, then moved on to join <b>Access to Media Education Society</b>, a non-profit organization that engages youth with digital mediums. My final co-op placement landed me in Japan, developing software for social robotics research at the <b>Advanced Telecommunications Research Institute</b>; I even got to be in a National Geographic docuseries!
                        </p>
                        <p>
                            Currently, I'm a Full-stack Software Developer on KPMG Vancouver's Data Analytics (Lighthouse) Team, as well as serving as its unofficial UI/UX Designer, engaging with clients and providing data-driven solutions.
                        </p>
                    </div>
                </Grid>
            </Grid>
